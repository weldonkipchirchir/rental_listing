...
const Notifications = () => {
  ...
  const fetchSentNotifications = async () => {
    try {
      const response = await getUserSentNotifications();
...
<>
                ...
                {filter !== "sent" && (
                  ...
                  >
                    <button className="absolute flex items-center px-2 py-2 font-semibold rounded-lg shadow-md dark:text-white bottom-1 right-1 max-md:text-sm hover:text-white hover:bg-primary hover:bg-primary-dark">
                      Reply
                    </button>
                  </NavLink>
                )}
