...
import { getAdminPaymentRecords } from '../../components/api/api';
          ...
          <table className="min-w-[1000px] w-full bg-white rounded-lg shadow-md dark:bg-gray-800">
            <thead>
              <tr>
                ...
                <th className="px-4 py-2 text-sm font-medium text-left text-gray-700 uppercase dark:text-gray-300">User</th>
            ...
            <tbody>
              {payments?.map((payment) => (
                <tr key={payment.id} className="border-t border-gray-200 dark:border-gray-700">
                  ...
                  <td className="px-4 py-2 text-gray-900 dark:text-gray-300">{payment.username}</td>
